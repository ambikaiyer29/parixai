...
const features = [
  {
    ...
    description: "Run the same prompt across GPT-4o, Claude, Gemini, Llama, and any model — side by side, same test data.",
  },
  {
    icon: (
    ...
    description: "Measure p50, p95, and p99 response times per model. Know exactly how fast each model responds in production.",
  },
  {
    icon: (
    ...
    title: "Cost Analysis",
    description: "Track token usage and cost per request, per model. See exactly what each experiment costs you in dollars.",
  },
  {
    icon: (
    ...
    description: "Define custom evaluation criteria. Score outputs with automated checks or human review workflows.",
  },
  {
    icon: (
    ...
    description: "Track every prompt change. Compare v1 vs v2 with the same test data to measure improvements objectively.",
  },
  {
    icon: (
    ...
    description: "Upload and manage test datasets. Reuse them across experiments to ensure consistent, repeatable evaluations.",
  },
  {
    icon: (
    ...
    description: "New model dropped? Re-run all your existing experiments against it instantly. No setup, no reconfiguration.",
  },
  {
    icon: (
    ...
    description: "Organize experiments by feature. See which model powers each part of your app and when it was last evaluated.",
  },
  {
    icon: (
    ...
    description: "Rich comparison charts for cost vs accuracy vs latency. Make decisions backed by data, not hunches.",
  },
];
